...
Njálgur smitast þegar egg komast í snertingu við munn og þaðan ofan í maga. Eggin klekjast í meltingarvegi og ormar verpa svo eggjum á svæði við endaþarm, en þau berast svo með óhreinum höndum út í umhverfi á næsta einstakling.`,
  "risvandamal": `Risvandi er algengt vandamál og um helmingur af körlum á aldrinum 40 til 70 ára lenda í vandræðum með stinningu á einhverjum tímapunkti yfir ævina.
## Algengar orsakir risvanda
Margir þættir geta haft áhrif á stinningu, bæði líkamlegir og sálfélagslegir.
- Samskiptaerfiðleikar eða önnur vandamál í parsambandinu.
- Ýmis lyf (t.d. við háum blóðþrýstingi, flogaveiki, þunglyndi eða vatnslosandi lyf).
- Afleiðing af sjúkdómum eins og hjartasjúkdómum eða sykursýki.
...
- Ef þú finnur fyrir þrýstingi eða verk í ennis- og kinnholum.
- Ef einkenni versna eða batna ekki eins og búist var við.`,
  "ristill": `Ristill er sársaukafull útbrot í húð sem stafa af endurvakningu hlaupabóluveirunnar (Varicella zoster).
## Helstu atriði
- Útbrotin fylgja oftast ákveðnu svæði á öðrum helmingi líkamans.
- Smitgefandi á meðan blöðrur eru opnar.
- Mikilvægt að halda útbrotum hreinum og þurrum.
...
- Mikilvægt er að stuðla að eðlilegu sýrustigi og góðri flóru í leggöngum.
- Leggangaþurrkur getur stuðlað að ójafnvægi á örveruflóru og aukið líkur á sýkingu.
...
- Tæmdu þvagblöðruna reglulega, sérstaklega fyrir og eftir samfarir.
...
## Hreinlæti og rykstjórnun
Góð rykstjórnun heima getur skipt sköpum. Mikilvægt er að fjarlægja hluti sem draga í sig ryk, svo sem flísteppi, og íhuga notkun lofthreinsitækja ef einkenni eru mikil.
## Gátlisti fyrir heimilið
- Ryksuga gólf og húsgögn reglulega
- Halda gæludýrum frá svefnherbergi
- Nota ilmefnalaus þvottaefni
- Lofta út þegar frjókornatala er lág
## Notkun ofnæmislyfja
- Skolun
Notaðu saltvatn til að skola nef og augu áður en þú notar ofnæmislyf.
- Hreinsun
Við skolun fjarlægjast frjókorn sem sitja í slímhúðinni.
- Lyfjagjöf
Þegar búið er að hreinsa svæðið virka lyfin þín best.`,
...
- Prófaðu þig áfram þar til rétta vörnin finnst
- Leitaðu ráðgjafar ef aukaverkanir koma fram
## Gott að vita
- Ekki hafa áhyggjur af frjósemi til frambúðar
- Ekki gleyma að frjósemi kemur fljótt aftur (nema eftir sprautu)
- Samfelld notkun (sleppa hléi) er ekki hættuleg
## Ef pillan gleymist
- Innan við 12 klst.
Taktu gleymdu pilluna strax (stundum 2 pillur sama dag). Öryggið minnkar ekki.
- Meira en 12 klst.
Taktu gleymdu pilluna og notaðu auk þess aðra vörn (t.d. smokk) næstu 7 daga.
- Færri en 7 pillur eftir?
Ef innan við 7 pillur eru eftir á spjaldinu, haltu beint áfram á næsta spjald án hlés.
## Fáðu ráðgjöf
- Heilsugæsla
