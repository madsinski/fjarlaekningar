...
export const THJONUSTA_FIELDS: SiteField[] = [
  ...
  { key: "test1_img", label: "Próf 1 — mynd af pakkningu (slóð)", group: "Heimapróf", type: "image" },
  ...
  { key: "test2_img", label: "Próf 2 — mynd af pakkningu (slóð)", group: "Heimapróf", type: "image" },
  ...
  { key: "test3_img", label: "Próf 3 — mynd af pakkningu (slóð)", group: "Heimapróf", type: "image" },
  ...
  { key: "tests_s1_img", label: "Skref 1 — skjámynd (slóð)", group: "Heimapróf", type: "image" },
  { key: "tests_s1_hl", label: "Skref 1 — áherslusvæði (x,y,b,h í %)", group: "Heimapróf", type: "value" },
  ...
  { key: "tests_s2_img", label: "Skref 2 — skjámynd (slóð)", group: "Heimapróf", type: "image" },
  { key: "tests_s2_hl", label: "Skref 2 — áherslusvæði (x,y,b,h í %)", group: "Heimapróf", type: "value" },
  ...
  { key: "tests_s3_img", label: "Skref 3 — skjámynd (slóð)", group: "Heimapróf", type: "image" },
  { key: "tests_s3_hl", label: "Skref 3 — áherslusvæði (x,y,b,h í %)", group: "Heimapróf", type: "value" },
