...
export const notifyMsgs = defineMessages(
  ...
  },
  {
    en: {
      ...
      "cta.planner": "Open shift planning",
      ...
      "digest.heading": "Changes to the schedule",
      "digest.intro": "The chief physician has made the following changes to your shifts:",
      "digest.mixed.subjectSingle": "An update in the shift system",
      "digest.mixed.subject_one": "{n} update in the shift system",
      "digest.mixed.subject_other": "{n} updates in the shift system",
      "digest.mixed.heading": "Updates in the shift system",
      ...
      "reset.subject": "New password — HSU shift system",
      "reset.heading": "New password",
      "reset.body": "A new password was requested for the Vestmannaeyjar Health Centre shift system. The link is valid for 2 hours.",
      ...
      "reset.text": "New password for the HSU shift system system: {url} (valid for 2 hours)",

      "password.subject": "Your password was changed",
      "password.heading": "Password changed",
      "password.line": "Your shift system password was changed and other devices were signed out. If this was not you, choose a new password straight away using “Forgot password” and let the chief physician know.",
