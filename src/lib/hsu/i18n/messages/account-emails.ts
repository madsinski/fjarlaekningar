...
export const accountEmails = defineMessages(
  ...
  },
  {
    en: {
      ...
      "layout.system": "Doctors' shifts · HSU",

      "invite.subject": "Your access to the HSU shift system",
      "invite.heading": "Welcome to the shift system",
      "invite.hello": "Hello {name},",
      "invite.body": "{by} has created an account for you in the doctors' shift system at Vestmannaeyjar Health Centre. There you enter your shift requests, see your shifts and can swap shifts on the shift market.",
      ...
      "invite.bodyReset": "{by} sent you a link to choose a new password for the doctors' shift system at Vestmannaeyjar Health Centre.",
      "invite.textReset": "Choose a new password for the HSU shift system: {url}",
      "invite.text": "Activate your account in the HSU shift system: {url}",

      "head.subject": "You are chief physician in the HSU shift system",
      "head.heading": "Welcome, chief physician",
      "head.body": "{by} has created an account for you as chief physician in the doctors' shift system at Vestmannaeyjar Health Centre. You plan the shifts: open requests from doctors, approve them, build the schedule and publish it.",
      ...
      "head.text": "Activate your chief physician account in the HSU shift system: {url}",

      "promoted.subject": "You are now chief physician in the HSU shift system",
      "promoted.heading": "You are chief physician",
      "promoted.body": "{by} has made you chief physician in the HSU shift system. You now have access to shift planning, where you open requests, approve them, build the schedule and publish it.",
      "promoted.steps": "The next time you open shift planning you'll get a tour and a checklist of first steps.",
      "promoted.cta": "Open shift planning",
      "promoted.text": "You are now chief physician in the HSU shift system. Shift planning: {url}",
      "promoted.notice": "{by} made you chief physician. Shift planning is under your name at the top of the page.",
    },
  },
);
