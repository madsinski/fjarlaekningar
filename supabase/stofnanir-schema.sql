...
create table if not exists public.partner_pages (
  ...
  title         text        not null default 'Þarftu að hitta lækni? Þú getur gert það þar sem þú ert.',
  intro         text        not null default 'Fjarlækningar leysa einföld og afmörkuð erindi. Þú svarar stuttum spurningalista og læknir metur málið og leggur til meðferð — sama þjónusta og á læknastofu, en skilvirkari leið og styttri biðlistar.',
